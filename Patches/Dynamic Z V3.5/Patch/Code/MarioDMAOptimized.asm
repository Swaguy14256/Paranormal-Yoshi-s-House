...
+
	...
	LDA !marioNormalCustomGFXBnkReal	;\
	STA $04					;/ Sets the custom Mario graphics bank. I really have no clue if the STX $04 was intentional, or a mistake. Seems to be the latter, but I really could not find any issues with that, so... yeah, fixed it just in case.
...
+
	...
	LDA !marioNormalCustomGFXBnkReal	;\
	STA $04					;/ Sets the custom Mario graphics bank. Original patch was missing this, so half of Mario would glitch up when using custom graphics. This routine runs whenever Mario is caped, or when Yoshi, Podoboos, or Baby Yoshis are present.
