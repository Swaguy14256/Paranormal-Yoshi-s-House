...
if read1($00FFD5) == $23
	...
	!addr = $6000
	!bank = $000000
	!bank2 = $00000000	; The second base address used for checking for edited messages. 
else
	...
	!addr = $0000
	!bank = $800000
	!bank2 = $80000000	; The second base address used for checking for edited messages.
endif
...
assert read4($05B1A3) == $03BB9022|!bank2, "Please edit the messages at least once before you apply this patch."
...
..IntroMessage
	...
	LDA $0DC5		;\
	BNE ..NEWCONTROLS	;/ Branches if the message type is not regular.
	LDA $18
	AND #$C0
	ORA $16
	AND #$F0
...
..NEWCONTROLS
	LDA $16			;\
	AND #$30		; | Branches if the Start or Select buttons are not pressed.
	BEQ ..Return		;/
	STZ $0DC5		; Sets the message type to regular.
	BRA ..RESUME		; Branches to the resume sublabel.
