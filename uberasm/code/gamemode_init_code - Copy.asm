...
SFXTEST:
	LDA $16			;\
	ORA $18			; | Branches if the L and R buttons are pressed.
	AND #$C0		; |
	BNE NOR			;/
	LDA $16			;\
...
;PER NewRoutineSt-1 ;push return address minus 1
;PHB ;push data bank
;LDA #$00 ;bank 00
;PHA ;push A on the stack
;PLB ;new data bank (bank 00)
;PEA $84CD ;push return address minus 1, containing PLB + RTL
;JML $009ED4			; Jumps to the address specified in the macro argument.
...
OOS:
	...
	JSL $109900
PHK ;push current program bank
PER numL-1 ;push return address minus 1
PHB ;push data bank
LDA #$00 ;bank 00
PHA ;push A on the stack
PLB ;new data bank (bank 00)
PEA $84CD ;push return address minus 1, containing PLB + RTL
LDA #$84
JML $009D57			; Jumps to the address specified in the macro argument.
numL:
	RTS
ERASE:
	LDA #$09
	...
	LDX #$00
PHK ;push current program bank
PER LABEL-1 ;push return address minus 1
PHB ;push data bank
LDA #$00 ;bank 00
PHA ;push A on the stack
PLB ;new data bank (bank 00)
PEA $84CD ;push return address minus 1, containing PLB + RTL
JML $009D3A			; Jumps to the address specified in the macro argument.
LABEL:
	RTS

label_009AC7: db $01,$FF,$FF

CURSOR:
	PHY
PHK ;push current program bank
PER NewRoutineSt2-1 ;push return address minus 1
PHB ;push data bank
LDA #$00 ;bank 00
PHA ;push A on the stack
PLB ;new data bank (bank 00)
...
label_009AD0:
	INC $1B91
PHK ;push current program bank
PER NewRoutineSt3-1 ;push return address minus 1
PHB ;push data bank
LDA #$00 ;bank 00
PHA ;push A on the stack
PLB ;new data bank (bank 00)
