...
!get_map16 = 0
macro get_map16()
	%include_once("routines/get_map16.asm", get_map16, $05)
	JSL get_map16
endmacro
!give_points = 0
macro give_points()
...
endmacro
!set_item_memory = 0
macro set_item_memory()
	%include_once("routines/set_item_memory.asm", set_item_memory, $12)
	JSL set_item_memory
endmacro
!shatter_block = 0
macro shatter_block()
	%include_once("routines/shatter_block.asm", shatter_block, $13)
	JSL shatter_block
endmacro
!spawn_bounce_sprite = 0
macro spawn_bounce_sprite()
	%include_once("routines/spawn_bounce_sprite.asm", spawn_bounce_sprite, $14)
	JSL spawn_bounce_sprite
endmacro
!spawn_item_sprite = 0
macro spawn_item_sprite()
	%include_once("routines/spawn_item_sprite.asm", spawn_item_sprite, $15)
	JSL spawn_item_sprite
endmacro
!spawn_sprite = 0
macro spawn_sprite()
	%include_once("routines/spawn_sprite.asm", spawn_sprite, $16)
	JSL spawn_sprite
endmacro
!spawn_sprite_block = 0
macro spawn_sprite_block()
	%include_once("routines/spawn_sprite_block.asm", spawn_sprite_block, $17)
	JSL spawn_sprite_block
endmacro
!sprite_block_position = 0
macro sprite_block_position()
	%include_once("routines/sprite_block_position.asm", sprite_block_position, $18)
	JSL sprite_block_position
endmacro
!swap_XY = 0
macro swap_XY()
	%include_once("routines/swap_XY.asm", swap_XY, $19)
	JSL swap_XY
endmacro
!teleport = 0
macro teleport()
	%include_once("routines/teleport.asm", teleport, $1A)
	JSL teleport
endmacro
