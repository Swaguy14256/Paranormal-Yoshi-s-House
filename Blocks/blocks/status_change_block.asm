...
CMP #!Coins				;\
BCC NOTENOUGHCOINS			;/ Branches if Mario has less than the configured number of coins.
...
print "A block that changes the M/L tile on Mario/Luigi part of the status bar if you have at least ",dec(!Coins)," coins. The tile itself depends on how many coins you currently have."