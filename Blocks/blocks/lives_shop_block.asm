...
LDA $18E4				;\
CLC					; |
ADC #!Lives				; | Gives Mario the configured number of lives. 
STA $18E4				;/
LDA $0DD9				;\
CLC					; |
ADC #!Coins				; | Removes the configured number of coins from Mario.
STA $0DD9				;/
HeadInside:
BodyInside:
RTL					; Ends the code.
...
print "A ? block that gives you ",dec(!Lives)," lives in exchange for !Coins coins."