...
!SpriteStop = $69		; How long a sprite stops before it turns around.
...
!ExtraInfo = !7FAB10
!X_Position = !1594
!Message1_Timer = !1558			; The RAM used for the first message timer.
!Message2_Timer = !163E
...
CMP #$01				; | Branches if the first message timer is 1.
BEQ Message1				;/
...
BRA ContinueZ				; Branches to the second message routine.
...
FramesPropertie:
Walk1Properties:
	db $4A,$4A,$4A,$4A,$4E,$4E,$4E,$4E,$4E,$4E
Walk2Properties:
	db $4A,$4A,$4A,$4A,$4E,$4E,$4E,$4E,$4E
Walk3Properties:
	db $4E,$4E,$4E,$4E,$4A,$4A,$4A,$4E,$4A,$4E,$4E
Walk4Properties:
	db $4A,$4A,$4A,$4A,$4E,$4E,$4E,$4E,$4E
Walk5Properties:
	db $4E,$4E,$4E,$4A,$4A,$4A,$4A,$4A,$4E,$4E,$4E
Idle1Properties:
	db $4A,$4A,$4A,$4A,$4E,$4E,$4E,$4E,$4E,$4E
Idle2Properties:
	db $4A,$4A,$4A,$4A,$4E,$4E,$4E,$4E,$4E,$4E
...
Walk1FlipXProperties:
	db $0A,$0A,$0A,$0A,$0E,$0E,$0E,$0E,$0E,$0E
Walk2FlipXProperties:
	db $0A,$0A,$0A,$0A,$0E,$0E,$0E,$0E,$0E
Walk3FlipXProperties:
	db $0E,$0E,$0E,$0E,$0A,$0A,$0A,$0E,$0A,$0E,$0E
Walk4FlipXProperties:
	db $0A,$0A,$0A,$0A,$0E,$0E,$0E,$0E,$0E
Walk5FlipXProperties:
	db $0E,$0E,$0E,$0A,$0A,$0A,$0A,$0A,$0E,$0E,$0E
