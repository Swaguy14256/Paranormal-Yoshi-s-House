...
PAUSETIME:
LDA $0F30				;\
CMP #$02				; | Branches if the time limit frame counter is 2 or more.
BCS DECTIME				;/
LDA $0F31				;\
...
BNE DECTIME				;/
LDA #$02				;\
STA $0F30				;/ Sets the time limit frame counter to 2 so the message progression works properly.
DECTIME:
RTS					; Ends the code.
...
FramesProperty:
Walk1Properties:
	db $4A,$4A,$4A,$4A,$4E,$4E,$4E,$4E,$4E,$4E,$4E
Walk2Properties:
...
Walk1FlipXProperties:
	db $0A,$0A,$0A,$0A,$0E,$0E,$0E,$0E,$0E,$0E,$0E
