...
!ThirdMessage = $06		; Level number for message 3. Then again, I could make it more complicated.

!MessageNumber = $02		; Message number for message 3. I can care less about changing this.
...
!Message3Timer = $1540			; This address is not in the original NPC sprite. I put it there for a reason.
...
AND #$02
BEQ CONTACT				; Branches if the sprite displays messages.
...
LDA !Message3Timer,x			;\ This was added by me.
BEQ NoMessage3				;/ This branches if the message 3 timer is 0.
JMP Message3				; Jumps to the message 3 routine.
...
BEQ ReturnZ				;/
JSR PAUSETIME				; Jumps to the pause time routine.
...
LDA #$02				;\ Sets the message 3 timer or in this case, "triple message."
STA !Message3Timer,x			;/
BRA ReturnZ				; Branches to the Return address.

Message3:
STZ $7B					; Sets Mario's speed to 0.
LDA #!ThirdMessage			;\ Added by me.
STA $13BF|!Base2			;/ Sets the translevel number.

LDA #!MessageNumber			;\
STA $1426|!Base2			;/ Displays the third message.
...
PAUSETIME:
LDA $0F30				;\
CMP #$03				; | Branches if the time limit frame counter is 3 or more.
BCS DECTIME				;/
LDA $0F31				;\
ORA $0F32				; | Branches if the time limit is 10 or more seconds
BNE DECTIME				;/
LDA $0F33				;\
CMP #$01				; | Branches if the time limit is more than 1 second.
BNE DECTIME				;/
LDA #$03				;\
STA $0F30				;/ Sets the time limit frame counter to 3 so the message progression works properly.
DECTIME:
RTS					; Ends the code.
...
FramesXDisp:
Walk1XDisp:
	db $09,$09,$01,$F9,$01,$F9,$09,$05,$01,$01,$09
Walk2XDisp:
...
Idle3XDisp:
	db $09,$09,$01,$F9,$01,$F9,$09,$05,$01,$01,$09
Walk1FlipXXDisp:
	db $FF,$FF,$FF,$07,$FF,$0F,$FF,$03,$07,$07,$FF
Walk2FlipXXDisp:
...
FramesYDisp:
Walk1YDisp:
	db $E9,$E5,$E1,$E1,$F1,$F1,$01,$E3,$E9,$01,$F1
Walk2YDisp:
...
Idle1YDisp:
	db $E9,$E5,$E1,$E1,$F1,$F1,$01,$E3,$E9,$01,$F1
Idle2YDisp:
	db $EA,$E6,$E2,$E2,$F2,$F2,$01,$E4,$EA,$01,$F2
Idle3YDisp:
	db $EA,$E6,$E2,$E2,$F2,$F2,$01,$E4,$EA,$01,$F2
Walk1FlipXYDisp:
	db $E9,$E5,$E1,$E1,$F1,$F1,$01,$E3,$E9,$01,$F1
...
FramesProperty:
Walk1Properties:
	db $4A,$4A,$4A,$4A,$4A,$4A,$4A,$4A,$4A,$4A,$4A
Walk2Properties:
	db $4A,$4A,$4A,$4A,$4A,$4A,$4A,$4A,$4A,$4A
Walk3Properties:
	db $4A,$4A,$4A,$4A,$4A,$4A,$4A,$4A,$4A,$4A,$4A,$4A
Walk4Properties:
	db $4A,$4A,$4A,$4A,$4A,$4A,$4A,$4A,$4A
Walk5Properties:
	db $4A,$4A,$4A,$4A,$4A,$4A,$4A,$4A,$4A,$4A,$4A
Idle1Properties:
	db $4A,$4A,$4A,$4A,$4A,$4A,$4A,$4A,$4A,$4A,$4A
...
Walk1FlipXProperties:
	db $0A,$0A,$0A,$0A,$0A,$0A,$0A,$0A,$0A,$0A,$0A
...
FramesTile:
Walk1Tiles: 
	db $AC,$AC,$A6,$A7,$A9,$AB,$BB,$AC,$AD,$BC,$BD
Walk2Tiles: 
...
FramesSize:
Walk1Size: 
	db $00,$00,$02,$02,$02,$00,$00,$00,$00,$00,$00
Walk2Size: 
...
VramTable:
	dw $0000,$0100,$0400,$0500,$0800,$0100,$0400,$0500
...
resource:
incbin showering_yoshi_npc.bin ; Replace this for the name of your GFX.
