...
FramesTotalTiles:
	db $07,$09,$0B,$08,$0A,$06,$06,$06,$07,$09,$0B,$08,$0A,$06,$06,$06
StartPositionFrames:
	dw $0007,$0011,$001D,$0026,$0031,$0038,$003F,$0046,$004E,$0058,$0064,$006D,$0078,$007F,$0086,$008D
EndPositionFrames:
	dw $0000,$0008,$0012,$001E,$0027,$0032,$0039,$0040,$0047,$004F,$0059,$0065,$006E,$0079,$0080,$0087

FramesXDisp:
Walk1XDisp:
	db $00,$00,$F8,$10,$00,$08,$00,$08
Walk2XDisp:
...
Idle1YDisp:
	db $DC,$EC,$EC,$FB,$FB,$D4,$D4
Idle2YDisp:
	db $DD,$ED,$ED,$FB,$FB,$D5,$D5
Idle3YDisp:
	db $DD,$ED,$ED,$FB,$FB,$D5,$D5
Walk1FlipXYDisp:
	db $DC,$EC,$F4,$F4,$FB,$FB,$D4,$D4
...
VramTable:
	dw $0800,$0100,$0400,$0500,$0800,$0900,$0C00,$0D00
...
resource:
incbin chef_yoshi_npc.bin ; Replace this for the name of your GFX.
