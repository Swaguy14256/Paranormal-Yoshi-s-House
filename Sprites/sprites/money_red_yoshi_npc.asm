...
!MessagePalette = $E0		; Which palette to read from for messages. Palette E by default.
...
!LevelForCutscene = $0049	; The level for the cutscene behaviour. Only 16-bit values work. When changing the value, it must be 4 digits long, and it must be in hexadecimal.
...
SetSpeed:
LDA $60					;\
CMP #$78				; | Branches if 2 seconds have passed since the sprite's halt in cutscene mode.
BEQ CUTSCENESPEED			;/
LDY !157C,x				; Set X speed based on direction.
LDA SpeedX,y
STA !B6,x
BRA NORMALSPEED				; Branches to the stop timer speed handler.
CUTSCENESPEED:
LDY !157C,x				;\
LDA CUTSCENEXSPEED,y			; | Sets the new speed for the sprite.
STA !B6,x				;/
NORMALSPEED:
...
NOReturnZ:
LDA $0DBF				;\
CMP #$63				; | Branches if Mario does not have 99 coins.
BNE NOTENOUGHCOINS			;/
LDA !ExtraInfo,x			;\
ORA #$04				; | Sets the extra bit.
STA !ExtraInfo,x			;/

NOTENOUGHCOINS:
REP #$20				; Turns on 16-bit addressing for the Accumulator.
LDA $010B				;\
CMP #!LevelForCutscene			; | Branches if Mario is not in the level used for the sprite's cutscene behaviour.
BNE NOTINLEVEL				;/
SEP #$20				; Turns on 8-bit addressing for the Accumulator.
JMP CUTSCENE				; Jumps to the cutscene movements routine. This stuff is hardcoded. Duuuuuuh.
...
CUTSCENE:
LDA $5C					;\
CMP #$FF				; | Branches if 4 1/4 seconds have passed.
BEQ STOPMOVING				;/
INC $5C					; Increments the walking timer.
JMP ReturnZ				; Jumps to the Return address.
STOPMOVING:
LDA #$FF				;\
STA !RAM_SprStopTimer,x			;/ Makes the sprite immobile.
LDA $60					;\
CMP #$78				; | Branches if 2 seconds have passed since the sprite's halt in cutscene mode.
BEQ RUNAWAY				;/
INC $60					; Increments the halt timer.
LDA #$01				;\
STA $63					;/ Sets the jump flag.
JMP ReturnZ				; Jumps to the Return address.
RUNAWAY:
LDA $63					;\
BEQ DONOTJUMP				;/ Branches if the jump flag is 0.
LDA #$D0				;\
STA $AA,x				;/ Sets the Y speed.
LDA #!JumpSFX				;\ Sets the sound to play.
STA !JumpSFXBank			;/ It glitches on default AddmusicK ROMs. Unless you fix and make $1DFA sounds not conflict with $1DFC and $1DF9 sounds, use the jump sounds in $1DF9 and $1DFC if AddmusicK is installed in the ROM.
LDA #$FF				;\
STA !RAM_SprStopTimer,x			;/ Makes the sprite immobile.
STZ $63					; Clears the jumping flag.
JMP ReturnZ				; Jumps to the Return address.
DONOTJUMP:
LDA $79					;\
CMP #$19				; | Branches if 25 frames have passed since the sprite ran away in cutscene mode.
BCS MOVEAWAY				;/
LDA $1588,x				;\
...
MOVEAWAY:
LDA $79					;\
CMP #$1B				; | Branches if 27 frames have passed since the sprite ran away in cutscene mode.
BCS TELEPORT				;/
LDA #$01				;\
STA !157C,x				; | Makes the sprite face left.
STZ !GlobalFlipper			;/
STZ !RAM_SprStopTimer,x			;\
LDA !ExtraProperty1,x			; | Makes the sprite mobile.
STA !RAM_SprTurnTimer,x			;/
INC $79					; Increments the running away timer.
JMP ReturnZ				; Jumps to the Return address.
TELEPORT:
LDA $1588,x				;\
...
BEQ DONOTTELEPORT			;/
LDA #$06				;\
STA $71					; | Teleports the player.
STZ $88					; |
STZ $89					;/
STZ $5C					;\
STZ $60					; | Resets the timers used in the cutscene.
STZ $79					;/
DONOTTELEPORT:
LDA #$FF				;\
STA !RAM_SprStopTimer,x			;/ Makes the sprite immobile.
...
FramesProperty:
Walk1Properties:
	db $48,$48,$48,$48,$4C,$4C,$4C,$4C,$4C,$4C,$4C
Walk2Properties:
	db $48,$48,$48,$48,$4C,$4C,$4C,$4C,$4C,$4C
Walk3Properties:
	db $4C,$4C,$4C,$4C,$48,$48,$48,$4C,$4C,$48,$4C,$4C
Walk4Properties:
	db $48,$48,$48,$48,$4C,$4C,$4C,$4C,$4C
Walk5Properties:
	db $4C,$4C,$4C,$48,$48,$48,$48,$48,$4C,$4C,$4C
Idle1Properties:
	db $48,$48,$48,$48,$4C,$4C,$4C,$4C,$4C,$4C,$4C
Idle2Properties:
	db $48,$48,$48,$48,$4C,$4C,$4C,$4C,$4C,$4C,$4C
...
Walk1FlipXProperties:
	db $08,$08,$08,$08,$0C,$0C,$0C,$0C,$0C,$0C,$0C
Walk2FlipXProperties:
	db $08,$08,$08,$08,$0C,$0C,$0C,$0C,$0C,$0C
Walk3FlipXProperties:
	db $0C,$0C,$0C,$0C,$08,$08,$08,$0C,$0C,$08,$0C,$0C
Walk4FlipXProperties:
	db $08,$08,$08,$08,$0C,$0C,$0C,$0C,$0C
Walk5FlipXProperties:
	db $0C,$0C,$0C,$08,$08,$08,$08,$08,$0C,$0C,$0C
